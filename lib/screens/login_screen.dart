  ...
  class _LoginScreenState extends State<LoginScreen> {
    ...
    bool isLoading = false; // Untuk tunjuk loading spinnner bila tekan butang
    ...
    // Fungsi untuk tunjuk pop-up error kalau login/register gagal
    ...
    void _handleSubmit() async {
      ...
      try {
        if (isLoginMode) {
          ...
          // Login berjaya, terus tolak pergi dashboard
          if (mounted) {
          ...
          // Simpan nama staff & role ke Firebase Realtime Database kau
          if (userCredential.user != null) {
            ...
            await _database.ref().child('users').child(uid).set({
              ...
              'name': name,
              'email': email,
              'role': 'staff', // Default role set kepada staff UTeM
              'createdAt': ServerValue.timestamp,
            });
          }

          // Lepas register setel, automatik tukar ke mod login balik
if (!mounted) return; // <--- TAMBAH BARIS NI KAT SINI
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                // 4. BUTANG SIGN IN / REGISTER (Bersama Loading Indicator)
                GestureDetector(
